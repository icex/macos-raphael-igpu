...
| Physical HDMI/DisplayPort | Candidate318 produces a user-confirmed visible hardware test pattern on the Samsung over iGPU HDMI at native1080p60. Fuzziness/interleaving were reported; correct pixels and desktop scanout remain unqualified. HDMI audio is not yet passed through or tested. |
...
- **Enable physical displays and HDMI audio:** Apple's embedded display core is being
  ...
  startup and visible HDMI patterns work; framebuffer fetch and image quality are next. [Port plan](findings/research/display-dcn315-port-20260917.md)
