...
## Next authorized run:273 raw decoder write pointer

Extend allowance11→12 on boot`c782d007-ca85-409b-9cf5-ff12c1a8c6d5` under continued
testing authorization. Match Linux raw shared/SCRATCH2 write pointer, retaining272
DPM capability correction and native queue ownership/commit. Require exact patch
and route guards, captured raw pointer and first packet evidence; hardware decode
first. Fresh MODE2,all identity/capture/host-fault/cleanup gates,max6000s.272 recovery
verified. No amdgpu rebind, merge or push. Stop through normal harness.
