...
DESCR = {
    ...
    "xk": "start the RLC microcontroller. The KIQ submission times out and the graphics core says why: RLC_CNTL=0, RLC_STAT=0, RLC_RLCS_BOOTLOAD_STATUS=0 -- the RLC F32 is not running, and on GFX10 the command processor cannot execute a ring without it (the CP itself is unhalted: CP_ME_CNTL and CP_MEC_CNTL both read 0 and CP_CPF_STATUS goes busy when the doorbell rings). Upstream gfx_v10_0_rlc_start is one field write, RLC_CNTL.RLC_ENABLE_F32=1, preceded by clearing RLC_CGCG_CGLS_CTRL and RLC_PG_CNTL; Apple has no 10_3 equivalent of _gc_unhalt_rlc_10_1, so on Navi 2x it must rely on the PSP autoloading and starting the RLC, which this PSP -- loading each blob individually via LOAD_IP_FW -- does not do.",
...
BITS = {"m1": 1, "m2": 2, "m3": 4, "m4": 8, "m5": 16, "m6": 32, "m7": 64, "d1": 128,
        "r1": 256, "p1": 512, "x1": 2048, "x2": 4096, "x3": 8192, "x4": 16384, "x5": 32768, "x6": 65536, "x7": 131072, "x8": 262144, "x9": 524288, "xa": 1048576, "xb": 2097152, "xc": 4194304, "xd": 8388608, "xe": 16777216, "xf": 33554432, "xg": 67108864, "xh": 134217728, "xi": 268435456, "xj": 536870912, "xk": 1073741824}
