...
def configure(version, card_id, attempt=None):
    ...
    if not re.fullmatch(r"1\.0\.((?:1[0-9]{2}|2[0-5][0-9]|260))", version):
        raise RuntimeError("candidate version must be 1.0.1NN, 1.0.2[0-5]N, or 1.0.260")
