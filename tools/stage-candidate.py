...
def configure(version, card_id, attempt=None):
    ...
    if not re.fullmatch(r"1\.0\.((?:1[0-9]{2}|2[0-5][0-9]|2[67][0-9]|280|281|282|283|284|285|286|287|288|289|290|291|292|293|294|295|296|297|298|299|300|301|302|303|304|305|306|307|308|309|310|311|312|313))", version):
        raise RuntimeError("candidate version must be in the reviewed 1.0.100–1.0.313 range")
