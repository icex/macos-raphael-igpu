...
def validate_card(raw, expected_sha256):
    ...
    if pair in (("1.0.184", "metal-017"), ("1.0.185", "metal-018"),
                ...
                ("1.0.191", "metal-025"), ("1.0.192", "metal-026"), ("1.0.193", "metal-027"), ("1.0.194", "metal-028"), ("1.0.195", "metal-029"), ("1.0.196", "metal-030"), ("1.0.197", "metal-031"), ("1.0.198", "metal-032"), ("1.0.199", "metal-033")), ("1.0.200", "metal-034")):
        candidate_contract = {
            ...
            "conditional_diagnostic_observations": ([
                ...
                "gdb_vmid1_prepared_root", "gdb_hub0_vmid1_reprogram1",
                 ...
                 if pair in (("1.0.193", "metal-027"), ("1.0.194", "metal-028"), ("1.0.195", "metal-029"), ("1.0.196", "metal-030"), ("1.0.197", "metal-031"), ("1.0.198", "metal-032"), ("1.0.199", "metal-033")), ("1.0.200", "metal-034")) else [])
              if pair in (("1.0.192", "metal-026"),
                          ("1.0.193", "metal-027"), ("1.0.194", "metal-028"),
                          ("1.0.195", "metal-029"), ("1.0.196", "metal-030"), ("1.0.197", "metal-031"), ("1.0.198", "metal-032"), ("1.0.199", "metal-033")), ("1.0.200", "metal-034")) else [
                "vmid1_fault_walk", "vmid1_fault_walk_view",
                "vmid1_fault_walk_entry",
            ])),
            "launch_options": ({
                ...
                "GENERIC_GRAPHICS": "off", "GDB": "on",
                          ...
                          ("1.0.190", "metal-024"),
                          ("1.0.191", "metal-025"),
                          ("1.0.192", "metal-026"), ("1.0.193", "metal-027"), ("1.0.194", "metal-028"), ("1.0.195", "metal-029"), ("1.0.196", "metal-030"), ("1.0.197", "metal-031"), ("1.0.198", "metal-032"), ("1.0.199", "metal-033")), ("1.0.200", "metal-034")) else {
                "BOOTDISK_MODE": "custom", "NVRAM": "stock",
    ...
    if pair in (("1.0.186", "metal-019"), ("1.0.187", "metal-020"),
        ...
        candidate186_contract = {
            ...
            "raphael_source_sha256": (
                ...
                if pair in (("1.0.199", "metal-033"), ("1.0.200", "metal-034")) else
                "21322441a50375280dad1bdffa319eca7a7bddebda004dbda23066f903e109ff"
                if pair in (("1.0.197", "metal-031"), ("1.0.198", "metal-032")) else
                "21322441a50375280dad1bdffa319eca7a7bddebda004dbda23066f903e109ff"
                if pair in (("1.0.197", "metal-031"), ("1.0.198", "metal-032"), ("1.0.199", "metal-033")), ("1.0.200", "metal-034")) else
    ...
    if pair in (("1.0.188", "metal-021"), ("1.0.188", "metal-022"),
        ...
        observed = (card.get("conditional_diagnostic_observations", [])
                    if pair in (("1.0.191", "metal-025"),
                                ("1.0.192", "metal-026"), ("1.0.193", "metal-027"), ("1.0.194", "metal-028"), ("1.0.195", "metal-029"), ("1.0.196", "metal-030"), ("1.0.197", "metal-031"), ("1.0.198", "metal-032"), ("1.0.199", "metal-033")), ("1.0.200", "metal-034")) else required)
...
def verify_build_inputs(experiment, builder, expected_commit,
    ...
    if (CANDIDATE_VERSION, CARD_ID) in (
            ...
            ("1.0.192", "metal-026"), ("1.0.193", "metal-027"), ("1.0.194", "metal-028"), ("1.0.195", "metal-029"), ("1.0.196", "metal-030"), ("1.0.197", "metal-031"), ("1.0.198", "metal-032"), ("1.0.199", "metal-033")), ("1.0.200", "metal-034")):
