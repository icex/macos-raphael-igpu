// Software encode then selected hardware/software decode. Run only under supervision.
...
int main(int argc, const char **argv) {
    @autoreleasepool {
        ...
        emit(@"invalidate-end", @{});
        // The hw argument selects DECODING here; encoding above remains software.
        if(samples.count) {
            ...
            if(!status && decoder) {
                CFTypeRef actualDecoder=NULL, actualRegistry=NULL;
